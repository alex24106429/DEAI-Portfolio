...
plaats Ames in de Amerikaanse staat Iowa. Hiermee ga je een model maken
dat hun verkoopprijs voorspelt. Hiervoor heb je in totaal 11 features
tot je beschikking.
...
5.  Initialiseer een lineair regressiemodel in je Jupyter Notebook en
    train deze op de juiste "stukken" uit stap 4b. Doe hierbij onderzoek
    naar de zogeheten "hyperparameters" die je bij dit model kan
    instellen met behulp van de pythonfunctie help(). Kies hierbij voor
    een willekeurige combinatie van minstens 2 hyperparameters. Noteer
    deze laatste twee zgn. "hyperparameters" in je logboek.
...
b.  Meer/andere aantallen epochs

c.  Meer/andere learning rates.
